            ...
            <div class="row">
                ...
                <div class="col-md-3" style="border-right:1px solid #ddd">
                    <ul class="nav nav-pills nav-stacked">
                       ...
                       <li class="  tabdisplay"  data-index="4"><a href="/spothiring/order/view_all_rides/<?php echo $order_no ?>"> View All Rides </a></li>
                       ...
                       <li class=" active tabdisplay"  data-index="4"><a href="/spothiring/order/view_invoices/<?php echo $order_no ?>"> View Invoices </a></li>
