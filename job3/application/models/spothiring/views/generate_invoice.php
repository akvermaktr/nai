...
<section id="content">
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                <form action="/spothiring/order/save_invoice_data" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="">
                                ...
                                <input type="hidden" name="provide_id" value="<?php echo $order_details[0]->or_placed_by ; ?>" />
                                <input type="hidden" name="buyer_id" value="<?php echo $order_details[0]->or_placed_by ; ?>" />
