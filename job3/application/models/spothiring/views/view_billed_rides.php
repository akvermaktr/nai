            ...
            <div class="row">
                ...
                <div class="col-md-3" style="border-right:1px solid #ddd">
                    <ul class="nav nav-pills nav-stacked">
                       ...
                       <li class="  tabdisplay"  data-index="4"><a href="/spothiring/order/view_pending_rides/<?php echo $order_id ?>"> View Pending Rides </a></li>
                       <li class="active  tabdisplay"  data-index="4"><a href="/spothiring/order/view_billed_rides/<?php echo $order_id ?>"> View Billed Rides </a></li>
