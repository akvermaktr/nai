...
.region.region-right-bottom div {
    ...
    <?php endif; ?>
           ...
           <!-- what'new -->
				...
				<div class="cl"></div>
                 ...
                 <div  class="what-new">
                    <?php print render($page['outer_images']); ?>
            ...
            <div class="left-part">
				...
				<div class="mt-news">
                	<ul>
                    	<li><a href="#"><img src="<?php print $base_path . $directory ?>/images/abhilekh.png" alt="" title=""></a></li>
                        <li><a href="#"><img src="<?php print $base_path . $directory ?>/images/my-gov-logo.png" alt="" title=""></a></li>
                        <li><a href="#"><img src="<?php print $base_path . $directory ?>/images/india-gov-logo.png" alt="" title=""></a></li>
                    </ul>
					</div>
				</div>-->
            ...
            <div class="right-box">
            	<div class="in-focus">
                	 <?php print render($page['in_focus']); ?>
                    <p><a href="in-focus"><?php $focus = t("In Focus"); print $focus; ?></a></p>
                </div><!--end of in-focus-->
                <div class="in-focus">
                	 <?php print render($page['media_gallery']); ?>
					   <p><a href="media-gallery"><?php $photo = t("Photo Gallery"); print $photo; ?></a></p>
                </div><!--end of in-focus-->
        ...
        <div class="footer">
                ...
                <div class="footerbox-left"><p>Visiter Counter: 2548796</p></div><!--end of footerbox-left-->
                <div class="footerbox-mid"><p>@ 2016, All rights reserved, National Informatics Centre Services Inc.</p></div><!--end of footerbox-mid-->
